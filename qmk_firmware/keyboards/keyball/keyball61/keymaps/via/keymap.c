...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , MS_BTN1  , MS_BTN2  , MO(2)    , MS_BTN3  , _______  ,
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , KC_GRAVE , KC_BACKSLASH , KC_EQUAL , KC_MINUS , AML_TO ,                                KC_PGUP  , KC_LEFT  , KC_UP    , KC_RIGHT , KC_HOME  , MC_0     ,
    _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  ,  DF(4)   ,             TO(3)   , KC_PGDN  , KC_BSPC  , KC_DOWN  , KC_DEL   , KC_END   , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,             _______ , _______  , _______  , _______  , _______  , _______  , _______
  ),

  [3] = LAYOUT_universal(
    RGB_TOG  , AML_TO   , AML_I50  , AML_D50  , SSNP_FRE , _______  ,                                  RGB_M_P  , RGB_M_B  , RGB_M_R  , RGB_M_SW , RGB_M_SN , RGB_M_K  ,
    ...
    _______  , _______  , SCRL_DVD , SCRL_DVI , SCRL_MO  , SCRL_TO  , TO(0)   ,             TO(0)    , _______  , _______  , _______  , _______  , _______  , _______  ,
    QK_BOOT  , EE_CLR  , _______  , _______  , _______  , _______  , _______  ,             _______  , _______  , _______  , _______  , _______  , EE_CLR   , QK_BOOT
  ),
